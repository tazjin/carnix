# Generated by carnix 0.6.6: carnix -o default.nix Cargo.lock
#
# This pins the nixpkgs version to an - admittedly arbitrarily chosen
# - commit with the correct dependencies. It should be removed after
# the 18.03 upgrade.
{ pkgs ? import <nixpkgs> {} }:
...
in
rec {
  carnix = f: carnix_0_6_7 { features = carnix_0_6_7_features { carnix_0_6_7 = f; }; };
  ...
  carnix_0_6_7_ = { dependencies?[], buildDependencies?[], features?[] }: buildRustCrate {
    crateName = "carnix";
    version = "0.6.7";
  ...
  carnix_0_6_7 = { features?(carnix_0_6_7_features {}) }: carnix_0_6_7_ {
  ...
  carnix_0_6_7_features = f: updateFeatures f (rec {
    carnix_0_6_7.default = (f.carnix_0_6_7.default or true);
